...
#ifndef UQ_INFORM_REALIZER_H
#define UQ_INFORM_REALIZER_H
...
//*****************************************************
/*! 
 * \class InformVectorRealizer
 * \brief A class for handling sampling from a non-informative Inform prior 
 * distribution.
 *
 * This class handles sampling from a Inform prior probability distribution
...
class InformVectorRealizer : public BaseVectorRealizer<V, M> {
public:
   ...
   * realizer. */
  InformVectorRealizer(const char *prefix,
                         const VectorSet<V, M> &unifiedImageSet, algver *av);

  //! Destructor
  ~InformVectorRealizer();
  //@}

  //! @name Realization-related methods
  //@{
  //! Draws a realization.
  /*! This function draws a realization of a Inform distribution and saves
